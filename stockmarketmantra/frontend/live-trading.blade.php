    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Live Trading</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
      ...
      <div class="row">
        ...
        <div class="col-lg-8">
          <div class="row">
            <!-- List Of Advisors -->
            <div class="col-12">
              <div class="card top-selling overflow-auto live_trading">
                ...
                <h5 class="card-title">Live Trading</h5>
                    ...
                    <div class="tab-pane fade show active" id="intraday" role="tabpanel" aria-labelledby="intraday-tab"> 
                      <table class="table table-borderless">
                        ...
                        <tbody>
                          <tr>
                            <td><a href="#" class="text-primary">08-Feb-2022 10:34</a></td>
                            <td class="fw-bold">Stove Kraft</td>
                            <td class="">loreum ipsum loreum ipsum loreum ipsum </td>
